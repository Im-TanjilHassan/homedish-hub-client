...
const Login = () => {
  ...
  return (
    <div className="py-6 mb-5 flex items-center justify-center">
      <div className="flex w-full max-w-4xl bg-white rounded-2xl overflow-hidden shadow-xl/30">
        ...
        <div className="flex-1 max-w-md w-full mx-auto lg:mx-0 backdrop-blur-xl p-6 sm:p-8">
          <div className="mb-8">
            ...
            <p className="mt-1 text-base text-slate-400">Welcome Back</p>
          </div>
          {showLoader && (
